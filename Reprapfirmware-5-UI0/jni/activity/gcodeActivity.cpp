...
static ZKButton* mBoard_SD_ButtonPtr;
static ZKButton* mPrint_again_ButtonPtr;
static ZKListView* mSet_ListViewPtr;
static ZKListView* mNum_ListViewPtr;
...
static ZKListView* mTask_ListPtr;
static ZKWindow* mTask_list_WindowPtr;
...
static ZKButton* mButton_add_listPtr;
...
static ZKButton* mmove10_ButtonPtr;
static ZKButton* mmove01_ButtonPtr;
static ZKButton* mmove1_ButtonPtr;
static ZKButton* mmove100_ButtonPtr;
...
static ZKButton* mButton_clPtr;
static ZKButton* mButton_tdPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_GCODE_Board_SD_Button, onButtonClick_Board_SD_Button,
    ID_GCODE_Print_again_Button, onButtonClick_Print_again_Button,
    ...
    ID_GCODE_Button_add_list, onButtonClick_Button_add_list,
    ...
    ID_GCODE_Button_cd, onButtonClick_Button_cd,
    ...
    ID_GCODE_move10_Button, onButtonClick_move10_Button,
    ID_GCODE_move01_Button, onButtonClick_move01_Button,
    ID_GCODE_move1_Button, onButtonClick_move1_Button,
    ID_GCODE_move100_Button, onButtonClick_move100_Button,
    ...
    ID_GCODE_Button_cl, onButtonClick_Button_cl,
    ID_GCODE_Button_td, onButtonClick_Button_td,
...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_GCODE_Set_ListView, getListItemCount_Set_ListView, obtainListItemData_Set_ListView, onListItemClick_Set_ListView,
    ID_GCODE_Num_ListView, getListItemCount_Num_ListView, obtainListItemData_Num_ListView, onListItemClick_Num_ListView,
    ...
    ID_GCODE_Task_List, getListItemCount_Task_List, obtainListItemData_Task_List, onListItemClick_Task_List,
...
gcodeActivity::~gcodeActivity() {
  ...
  // 退出应用时需要反注册
    ...
    onUI_quit();
    mActivityPtr = NULL;
    mBoard_SD_ButtonPtr = NULL;
    mPrint_again_ButtonPtr = NULL;
    mSet_ListViewPtr = NULL;
    mNum_ListViewPtr = NULL;
    ...
    mmove10_ButtonPtr = NULL;
    mmove01_ButtonPtr = NULL;
    mmove1_ButtonPtr = NULL;
    mmove100_ButtonPtr = NULL;
...
void gcodeActivity::onCreate() {
	Activity::onCreate();
    mBoard_SD_ButtonPtr = (ZKButton*)findControlByID(ID_GCODE_Board_SD_Button);
    mPrint_again_ButtonPtr = (ZKButton*)findControlByID(ID_GCODE_Print_again_Button);
    mSet_ListViewPtr = (ZKListView*)findControlByID(ID_GCODE_Set_ListView);if(mSet_ListViewPtr!= NULL){mSet_ListViewPtr->setListAdapter(this);mSet_ListViewPtr->setItemClickListener(this);}
    mNum_ListViewPtr = (ZKListView*)findControlByID(ID_GCODE_Num_ListView);if(mNum_ListViewPtr!= NULL){mNum_ListViewPtr->setListAdapter(this);mNum_ListViewPtr->setItemClickListener(this);}
    ...
    mTask_ListPtr = (ZKListView*)findControlByID(ID_GCODE_Task_List);if(mTask_ListPtr!= NULL){mTask_ListPtr->setListAdapter(this);mTask_ListPtr->setItemClickListener(this);}
    mTask_list_WindowPtr = (ZKWindow*)findControlByID(ID_GCODE_Task_list_Window);
    ...
    mButton_add_listPtr = (ZKButton*)findControlByID(ID_GCODE_Button_add_list);
    ...
    mButton_cdPtr = (ZKButton*)findControlByID(ID_GCODE_Button_cd);
    ...
    mmove10_ButtonPtr = (ZKButton*)findControlByID(ID_GCODE_move10_Button);
    mmove01_ButtonPtr = (ZKButton*)findControlByID(ID_GCODE_move01_Button);
    mmove1_ButtonPtr = (ZKButton*)findControlByID(ID_GCODE_move1_Button);
    mmove100_ButtonPtr = (ZKButton*)findControlByID(ID_GCODE_move100_Button);
    ...
    mButton_clPtr = (ZKButton*)findControlByID(ID_GCODE_Button_cl);
    mButton_tdPtr = (ZKButton*)findControlByID(ID_GCODE_Button_td);
