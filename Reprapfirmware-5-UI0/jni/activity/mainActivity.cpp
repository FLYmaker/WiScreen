...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_MAIN_LVFolder, getListItemCount_LVFolder, obtainListItemData_LVFolder, onListItemClick_LVFolder,
};
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mLVFolderPtr = (ZKListView*)findControlByID(ID_MAIN_LVFolder);if(mLVFolderPtr!= NULL){mLVFolderPtr->setListAdapter(this);mLVFolderPtr->setItemClickListener(this);}
